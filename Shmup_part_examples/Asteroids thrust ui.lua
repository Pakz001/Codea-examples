...
-- add the ui space.png as uispace as 640x480 sprite asset and add mytiles 2.png as mytiles as a 640x480 sprite asset in code editor.

laserbolt = class()
laserboltmaxdistance = 100
laserboltspeed = 5
laserboltsize = 16
            ...
            if map[x2]~=nil and map[x2][y2]~=nil then
                if map[x2][y2] ~= 2 then
                    ...
                    if rectsoverlap(x+offsetx,y+offsety,w,h,x3,y3,tilewidth,tileheight) then
                        if math.random()*10<2 then map[x2][y2]=nil end
                        return true
                    end
                end
            end
            ...
            if map[x2]~=nil and map[x2][y2]~=nil then
                if map[x2][y2] ~= 2 then
                    ...
                    get_line_intersect(x,y,xt,yt,x3+tilewidth,y3,x3+tilewidth,y3+tileheight) then
                        ...
                        if underground == false then map[x2][y2]=nil else map[x2][y2]=2 end
